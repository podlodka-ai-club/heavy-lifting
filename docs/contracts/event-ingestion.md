...
- For the current MVP slice, `worker1` polls tracker comments for estimate-only `execute` threads and for done triage threads that already published a tracker-facing triage comment.
